...
if __name__ == "__main__":
    file_path = "./data/ori/all_data/Controls/Control 12/" #/Compounds_renamed/"# /Controls/Control 1, 2, 3, 4_candidates....
    save_path = "./data/cleaned/all_data/Controls/Control_12/" #/Compounds/" # /Controls/Control_1, 2, 3, ....
