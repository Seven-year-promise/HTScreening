...
if __name__ == "__main__":
    file_path = ORI_PATH / "all_data/Compounds_renamed/"  #/Compounds_renamed/"# /Controls/Control 1, 2, 3, 4_candidates....
    save_path = SAVE_CLEAN_PATH / "all_data/Compounds/" #/Compounds/" # /Controls/Control_1, 2, 3, ....
