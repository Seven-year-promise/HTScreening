...
import visdom
from vae_plots import plot_latent_no_class, save_loss
import torchvision
...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        if epoch == args.tsne_iter:
            ...
            plot_latent_no_class(vae=model, test_loader=eval_loader, batch_size=batch_size, z_dim=z_dim, args=args, save_path=args.main_path)
